...
void main() async {
  ...
  group('ko_KR 테스트', () {
    ...
    testWidgets('title1 테스트', (tester) async {
      await koKRLocalizedWidgetForTesting(tester, text: LocaleKeys.title1);
    });
    testWidgets('title2 테스트', (tester) async {
      await koKRLocalizedWidgetForTesting(tester, text: LocaleKeys.title2);
    });
    testWidgets('title3 테스트', (tester) async {
      await koKRLocalizedWidgetForTesting(tester, text: LocaleKeys.title3);
    });
  });
  ...
  group('en-US 테스트', () {
    ...
    testWidgets('title1 테스트', (tester) async {
      await enUSLocalizedWidgetForTesting(tester, text: LocaleKeys.title1);
    });
    testWidgets('title2 테스트', (tester) async {
      await enUSLocalizedWidgetForTesting(tester, text: LocaleKeys.title2);
    });
    testWidgets('title3 테스트', (tester) async {
      await enUSLocalizedWidgetForTesting(tester, text: LocaleKeys.title3);
    });
  });
}
